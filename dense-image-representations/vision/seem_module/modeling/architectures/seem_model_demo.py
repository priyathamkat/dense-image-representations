...
class GeneralizedSEEM(nn.Module):
    ...
    def evaluate(self, batched_inputs):
        ...
        mask_pred_embs = outputs["pred_maskembs"]
    ...
    def instance_inference(self, mask_cls, mask_pred, box_pred, mask_pred_emb):
        ...
        mask_pred_emb = mask_pred_emb[topk_indices]
        ...
        if self.panoptic_on:
            ...
            mask_pred_emb = mask_pred_emb[keep]

            if box_pred is not None:
                box_pred = box_pred[keep]

        result = Instances(image_size)
        result.pred_mask_embs = mask_pred_emb
